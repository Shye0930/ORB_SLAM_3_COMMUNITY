...
namespace ORB_SLAM3
{
    ...
    mnInitialFrameId(0), mbCreatedMap(false), mnFirstFrameId(0), mpCamera2(nullptr), mpLastKeyFrame(static_cast<KeyFrame*>(NULL))
    {
        ...
        // [HACK] Obtain the angles which will be used to rotate the world frame
        Tc0w = Sophus::SE3f();
    ...
    void Tracking::Track()
    {
        ...
        if(mState==NOT_INITIALIZED)
        {
            ...
            mpFrameDrawer->Update(this); //[Hack] Edited this
        ...
        else
        {
            ...
            if(!mbOnlyTracking)
            {
                ...
                else
                {
                    ...
                    else if (mState == LOST || mState == RECENTLY_LOST) // [Hack] Edited this. Og: else if (mState == LOST)
                    {
    ...
    void Tracking::StereoInitialization()
    {
        if(mCurrentFrame.N>500)
        {
            ...
            mnLastRelocFrameId = mCurrentFrame.mnId; //[HACK] Edited this
